...
class HexForce extends Force {
  ...
  static const int R1_I = DR | UL,              R1_O = L | R;
  static const int R2_I = L | DR | UL,          R2_O = L | UR | DL;
  static const int R3_I = L | UR | DL,          R3_O = L | UL | DR;
  static const int R4_I = L | DR | UR,          R4_O = R | DL | UL;
  static const int R5_I = DR | DL | UR | UL,    R5_O = L | R | UL | DR;

  // Only other non-symmetric rotation of R1.
  static const int R6_I = UR | DL,              R6_O = L | R;

  // Mirrors of 2 & 3
  static const int R7_I = R | UR | DL,          R7_O = R | UL | DR;
  static const int R8_I = R | DR | UL,          R8_O = R | UR | DL;

  // 4 rotations of 5-inputs.
  static const int R9_I = R | L | DR | UR | UL, R9_O = L | R | UL | DL | UR;
  static const int RA_I = R | L | DR | UR | DL, RA_O = L | R | UL | DL | DR;
  static const int RB_I = R | L | DL | UL | UR, RB_O = L | R | UR | DR | UL;
  static const int RC_I = R | L | DL | UL | DR, RC_O = L | R | UR | DR | DL;
