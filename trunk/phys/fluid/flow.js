...
$$.Object = {"":
 ...
 drawTest$0: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('drawTest', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'drawTest', [])
},
 getValues$0: function () {
  return this.noSuchMethod$2
 ...
 line$0: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('line', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'line', [])
},
...
$$.Flow = {"":
 ["grid", "hexGrid", "palette", "graphics", "frame", "force", "next", "space", "gridScale", "radius", "compareStep", "hexSize", "sleep", "num", "width"],
 super: "Object",
 run$0: function() {
 },
 ...
 Flow$0: function() {
  ...
  this.compareStep = -1;
  this.gridScale = 10;
  this.graphics = $.query('#canvas').getContext$1('2d');
  this.radius = this.width;
  var t1 = this.radius;
  this.hexGrid = $.HexGrid$(t1, t1, this.gridScale, this.graphics);
  this.hexGrid.drawTest$0();
 }
};
...
$$.HexGrid = {"":
 ["radius", "y", "x", "yOffset", "yStride", "xStride", "count", "scale", "rows", "cols", "g", "TAU", "DRAW_BORDER"],
 super: "Object",
 line$0: function() {
  var t1 = this.x;
  if (typeof t1 !== 'number') return this.line$0$bailout(1, t1, 0, 0);
  var t3 = this.count;
  var t4 = this.xStride;
  if (typeof t4 !== 'number') return this.line$0$bailout(2, t1, t3, t4);
  this.x = t1 + -1 * (t3 * t4);
  var t6 = this.y;
  if (typeof t6 !== 'number') return this.line$0$bailout(3, t6, 0, 0);
  t1 = this.yOffset;
  if (typeof t1 !== 'number') return this.line$0$bailout(4, t6, t1, 0);
  t1 = t1 < 0;
  t3 = this.yStride;
  if (typeof t3 !== 'number') return this.line$0$bailout(5, t6, t1, t3);
  if (t1) t1 = t3;
  else t1 = 2 * t3;
  this.y = t6 + t1;
  t1 = this.yOffset;
  if (typeof t1 !== 'number') return this.line$0$bailout(6, t1, 0, 0);
  t3 = t1 < 0;
  if (typeof t1 !== 'number') return this.line$0$bailout(7, t1, t3, 0);
  t3 && (t1 = -t1);
  this.yOffset = t1;
  this.count = 0;
 },
 line$0$bailout: function(state, env0, env1, env2) {
  switch (state) {
    case 1:
      t1 = env0;
      break;
 ...
 next$1: function(color) {
  var t1 = this.g;
  t1.beginPath$0();
  t1.set$fillStyle(color);
  var t2 = this.x;
  var t3 = this.y;
  var t4 = this.radius;
  var t5 = this.TAU;
  t1.arc$6(t2, t3, t4, 0, t5, false);
  if (this.DRAW_BORDER === true) {
    t1.set$fillStyle('blue');
    t1.arc$6(this.x, this.y, 3, 0, t5, false);
  }
  t1.fill$0();
  t1.closePath$0();
  t1.stroke$0();
  this.x = $.add(this.x, this.xStride);
  this.y = $.add(this.y, this.yOffset);
  this.yOffset = $.mul(this.yOffset, -1);
  this.count = this.count + 1;
 },
 reset$0: function() {
  this.x = 0;
  this.y = 0;
  this.yOffset = this.yStride;
  this.count = 0;
 },
 drawTest$0: function() {
  var I = this.cols;
  if (typeof I !== 'number') return this.drawTest$0$bailout(1, I, 0);
  var J = this.rows;
  if (typeof J !== 'number') return this.drawTest$0$bailout(2, J, I);
  var i = 0;
  for (; i < I; ++i) {
    for (var j = 0; j < J; ++j) {
      this.next$1('black');
 ...
 drawTest$0$bailout: function(state, env0, env1) {
  switch (state) {
    case 1:
      I = env0;
      break;
 ...
 HexGrid$4: function(columns, rows, scale, graphics) {
  ...
  this.x = 0;
  this.y = 0;
  if (typeof scale !== 'number') throw $.iae(scale);
  this.xStride = 3 * scale;
  this.yStride = 2 * scale;
  this.yOffset = this.yStride;
  this.count = 0;
  this.radius = scale;
 }
...
$.HexGrid$ = function(columns, rows, scale, graphics) {
  var t1 = new $.HexGrid(null, null, null, null, null, null, null, null, null, null, null, 6.283185307179586, false);
...
$.Flow$ = function() {
  var t1 = new $.Flow(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.Flow$0();
  return t1;
};
