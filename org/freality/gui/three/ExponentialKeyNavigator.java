...
/**
 * This is the ExponentialKeyNavigator class.  It accumulates AWT key events (key
 * press and key release) and computes a new transform based on the
 * accumulated events and elapsed time.
 */
public class ExponentialKeyNavigator {
     ...
     */
    public ExponentialKeyNavigator(TransformGroup targetTG, double maxMove) {
